...
Filename: "sc.exe"; Parameters: "create {#MyServiceName} binPath= ""{app}\Service\XKantor.LocalAgent.Service.exe"" start= auto DisplayName= ""{#MyAppName}"""; Flags: runhidden waituntilterminated
...
Filename: "schtasks.exe"; Parameters: "/create /tn ""{#MyTaskName}"" /tr ""\""{app}\UserSession\XKantor.LocalAgent.UserSession.exe\"""" /sc onlogon /rl limited /f"; Flags: runhidden waituntilterminated
...
; odinstalowaniu - patrz docs/INSTALLATION.md ("nie unieważniamy parowania przez przypadek").
